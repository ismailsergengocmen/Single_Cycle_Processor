...
##Buttons
set_property PACKAGE_PIN U18 [get_ports switchBut]						
	set_property IOSTANDARD LVCMOS33 [get_ports switchBut]
set_property PACKAGE_PIN T18 [get_ports resetBut]						
	set_property IOSTANDARD LVCMOS33 [get_ports resetBut]
set_property PACKAGE_PIN W19 [get_ports decreaseBut]						
	set_property IOSTANDARD LVCMOS33 [get_ports decreaseBut]
set_property PACKAGE_PIN T17 [get_ports increaseBut]						
	set_property IOSTANDARD LVCMOS33 [get_ports increaseBut]
set_property PACKAGE_PIN U17 [get_ports nextBut]						
    set_property IOSTANDARD LVCMOS33 [get_ports nextBut]
